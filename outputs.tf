...
output "stream_analytics_jobs_content_storage_policy" {
  ...
  value       = { for k, v in azurerm_stream_analytics_job.stream_analytics_jobs : k => v.content_storage_policy }
}
output "stream_analytics_jobs_data_locale" {
  ...
  value       = { for k, v in azurerm_stream_analytics_job.stream_analytics_jobs : k => v.data_locale }
}
output "stream_analytics_jobs_events_late_arrival_max_delay_in_seconds" {
  ...
  value       = { for k, v in azurerm_stream_analytics_job.stream_analytics_jobs : k => v.events_late_arrival_max_delay_in_seconds }
}
output "stream_analytics_jobs_events_out_of_order_max_delay_in_seconds" {
  ...
  value       = { for k, v in azurerm_stream_analytics_job.stream_analytics_jobs : k => v.events_out_of_order_max_delay_in_seconds }
}
output "stream_analytics_jobs_events_out_of_order_policy" {
  ...
  value       = { for k, v in azurerm_stream_analytics_job.stream_analytics_jobs : k => v.events_out_of_order_policy }
}
output "stream_analytics_jobs_identity" {
  ...
  value       = { for k, v in azurerm_stream_analytics_job.stream_analytics_jobs : k => v.identity }
}
output "stream_analytics_jobs_job_id" {
  ...
  value       = { for k, v in azurerm_stream_analytics_job.stream_analytics_jobs : k => v.job_id }
}
output "stream_analytics_jobs_job_storage_account" {
  ...
  value       = { for k, v in azurerm_stream_analytics_job.stream_analytics_jobs : k => v.job_storage_account }
  sensitive   = true
}
output "stream_analytics_jobs_location" {
  ...
  value       = { for k, v in azurerm_stream_analytics_job.stream_analytics_jobs : k => v.location }
}
output "stream_analytics_jobs_name" {
  ...
  value       = { for k, v in azurerm_stream_analytics_job.stream_analytics_jobs : k => v.name }
}
output "stream_analytics_jobs_output_error_policy" {
  ...
  value       = { for k, v in azurerm_stream_analytics_job.stream_analytics_jobs : k => v.output_error_policy }
}
output "stream_analytics_jobs_resource_group_name" {
  ...
  value       = { for k, v in azurerm_stream_analytics_job.stream_analytics_jobs : k => v.resource_group_name }
}
output "stream_analytics_jobs_sku_name" {
  ...
  value       = { for k, v in azurerm_stream_analytics_job.stream_analytics_jobs : k => v.sku_name }
}
output "stream_analytics_jobs_stream_analytics_cluster_id" {
  ...
  value       = { for k, v in azurerm_stream_analytics_job.stream_analytics_jobs : k => v.stream_analytics_cluster_id }
}
output "stream_analytics_jobs_streaming_units" {
  ...
  value       = { for k, v in azurerm_stream_analytics_job.stream_analytics_jobs : k => v.streaming_units }
}
output "stream_analytics_jobs_tags" {
  ...
  value       = { for k, v in azurerm_stream_analytics_job.stream_analytics_jobs : k => v.tags }
}
output "stream_analytics_jobs_transformation_query" {
  ...
  value       = { for k, v in azurerm_stream_analytics_job.stream_analytics_jobs : k => v.transformation_query }
}
output "stream_analytics_jobs_type" {
  ...
  value       = { for k, v in azurerm_stream_analytics_job.stream_analytics_jobs : k => v.type }
}
